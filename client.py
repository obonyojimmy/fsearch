...
class Client:
    ...
    def __init__(self, host:str, port: int, certfile: str = None, keyfile: str = None):
        ...
        if certfile:
            self.load_ssl(certfile, keyfile)

        self.connect()

    def load_ssl(self, certfile: str, keyfile: str = None):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "-c", "--cert",
        type=str,
        help="Optional SSL server cert file path"
    )
    parser.add_argument(
        "-k", "--key",
        type=str,
        help="Optional cert key file path"
    )
    parser.add_argument(
        "query",
        type=str,
    ...
    args: ClientArgs = parser.parse_args()
